...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    //Will find the title,image according to the passed ID
    final getCurrProduct = productProviders.findProdByID(productId);
    //get the corresponding price depending on whether it is on sale or not
                      ...
                      child: Row(
                        ...
                        children: [
                          Flexible(
                            ...
                            //   text:
                            //       'I dreamt of you last night and i cannot stop thinking about you',
                            //   color: color,
                            //   textSize: 25,
                            //   isTitle: true,
                            //   //maxLines: 2,
